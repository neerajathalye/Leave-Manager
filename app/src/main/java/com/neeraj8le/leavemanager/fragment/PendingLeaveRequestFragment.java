...
public class PendingLeaveRequestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        leaves.add(new Leave(1, 2, "Maternity Leave", "Had a baby", "1 Apr 17", "1 May 17", 0, "30 Mar 17"));
        leaves.add(new Leave(1, 2, "Study Leave", "studying for mba", "10 Apr 17", "1 May 17", 1, "30 Mar 17"));
        leaves.add(new Leave(1, 2, "Casual Leave", "just for fun", "27 Apr 17", "14 May 17", 2, "30 Mar 17"));
